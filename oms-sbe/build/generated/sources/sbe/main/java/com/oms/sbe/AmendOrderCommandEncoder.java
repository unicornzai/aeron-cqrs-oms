...
/**
 * Client amends price or quantity of an open order
 */
@SuppressWarnings("all")
public final class AmendOrderCommandEncoder implements MessageEncoderFlyweight
{
    ...
    private final AmendOrderCommandEncoder parentMessage = this;
    ...
    public AmendOrderCommandEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public AmendOrderCommandEncoder wrapAndApplyHeader(
    ...
    public AmendOrderCommandEncoder sequenceNumber(final long value)
    {
    ...
    public AmendOrderCommandEncoder timestamp(final long value)
    {
    ...
    public AmendOrderCommandEncoder correlationId(final long value)
    {
    ...
    public AmendOrderCommandEncoder orderId(final long value)
    {
    ...
    public AmendOrderCommandEncoder accountId(final long value)
    {
    ...
    public AmendOrderCommandEncoder newPrice(final long value)
    {
    ...
    public AmendOrderCommandEncoder newQuantity(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final AmendOrderCommandDecoder decoder = new AmendOrderCommandDecoder();
