...
public final class OrderCancelledEventEncoder implements MessageEncoderFlyweight
{
    ...
    private final OrderCancelledEventEncoder parentMessage = this;
    ...
    public OrderCancelledEventEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrderCancelledEventEncoder wrapAndApplyHeader(
    ...
    public OrderCancelledEventEncoder sequenceNumber(final long value)
    {
    ...
    public OrderCancelledEventEncoder timestamp(final long value)
    {
    ...
    public OrderCancelledEventEncoder correlationId(final long value)
    {
    ...
    public OrderCancelledEventEncoder orderId(final long value)
    {
    ...
    public OrderCancelledEventEncoder accountId(final long value)
    {
    ...
    public OrderCancelledEventEncoder cancelReason(final CancelReason value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final OrderCancelledEventDecoder decoder = new OrderCancelledEventDecoder();
