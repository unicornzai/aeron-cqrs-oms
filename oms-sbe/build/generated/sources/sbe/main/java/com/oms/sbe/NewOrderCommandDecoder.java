...
public final class NewOrderCommandDecoder implements MessageDecoderFlyweight
{
    ...
    private final NewOrderCommandDecoder parentMessage = this;
    ...
    public NewOrderCommandDecoder wrap(
    ...
    public NewOrderCommandDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public NewOrderCommandDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[NewOrderCommand](sbeTemplateId=");
    ...
    public NewOrderCommandDecoder sbeSkip()
    {
        sbeRewind();
