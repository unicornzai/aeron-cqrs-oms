...
public final class OrderAmendedEventDecoder implements MessageDecoderFlyweight
{
    ...
    private final OrderAmendedEventDecoder parentMessage = this;
    ...
    public OrderAmendedEventDecoder wrap(
    ...
    public OrderAmendedEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderAmendedEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[OrderAmendedEvent](sbeTemplateId=");
    ...
    public OrderAmendedEventDecoder sbeSkip()
    {
        sbeRewind();
