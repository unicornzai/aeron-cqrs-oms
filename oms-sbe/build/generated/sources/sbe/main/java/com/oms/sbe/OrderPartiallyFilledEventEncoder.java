...
/**
 * Order partially filled, remainder open
 */
@SuppressWarnings("all")
public final class OrderPartiallyFilledEventEncoder implements MessageEncoderFlyweight
{
    ...
    private final OrderPartiallyFilledEventEncoder parentMessage = this;
    ...
    public OrderPartiallyFilledEventEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrderPartiallyFilledEventEncoder wrapAndApplyHeader(
    ...
    public OrderPartiallyFilledEventEncoder sequenceNumber(final long value)
    {
    ...
    public OrderPartiallyFilledEventEncoder timestamp(final long value)
    {
    ...
    public OrderPartiallyFilledEventEncoder correlationId(final long value)
    {
    ...
    public OrderPartiallyFilledEventEncoder orderId(final long value)
    {
    ...
    public OrderPartiallyFilledEventEncoder accountId(final long value)
    {
    ...
    public OrderPartiallyFilledEventEncoder fillPrice(final long value)
    {
    ...
    public static int fillQuantityId()
    {
        return 7;
    }

    public static int fillQuantitySinceVersion()
    {
        return 0;
    }

    public static int fillQuantityEncodingOffset()
    {
        return 48;
    }

    public static int fillQuantityEncodingLength()
    {
        return 8;
    }

    public static String fillQuantityMetaAttribute(final MetaAttribute metaAttribute)
    {
        if (MetaAttribute.PRESENCE == metaAttribute)
        {
            return "required";
    ...
    public static long fillQuantityNullValue()
    {
        return -9223372036854775808L;
    }

    public static long fillQuantityMinValue()
    {
        return -9223372036854775807L;
    }

    public static long fillQuantityMaxValue()
    {
        return 9223372036854775807L;
    }

    public OrderPartiallyFilledEventEncoder fillQuantity(final long value)
    {
    ...
    public OrderPartiallyFilledEventEncoder remainingQty(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final OrderPartiallyFilledEventDecoder decoder = new OrderPartiallyFilledEventDecoder();
