...
public final class OrderCancelledEventDecoder implements MessageDecoderFlyweight
{
    ...
    private final OrderCancelledEventDecoder parentMessage = this;
    ...
    public OrderCancelledEventDecoder wrap(
    ...
    public OrderCancelledEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderCancelledEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[OrderCancelledEvent](sbeTemplateId=");
    ...
    public OrderCancelledEventDecoder sbeSkip()
    {
        sbeRewind();
