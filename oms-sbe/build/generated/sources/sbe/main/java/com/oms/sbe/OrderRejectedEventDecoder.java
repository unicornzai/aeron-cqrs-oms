...
public final class OrderRejectedEventDecoder implements MessageDecoderFlyweight
{
    ...
    private final OrderRejectedEventDecoder parentMessage = this;
    ...
    public OrderRejectedEventDecoder wrap(
    ...
    public OrderRejectedEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderRejectedEventDecoder sbeRewind()
    {
    ...
    {
        return RejectReason.get(((short)(buffer.getByte(offset + 40) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[OrderRejectedEvent](sbeTemplateId=");
    ...
    public OrderRejectedEventDecoder sbeSkip()
    {
        sbeRewind();
