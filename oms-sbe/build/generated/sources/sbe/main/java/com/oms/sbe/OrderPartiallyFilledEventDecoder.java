...
public final class OrderPartiallyFilledEventDecoder implements MessageDecoderFlyweight
{
    ...
    private final OrderPartiallyFilledEventDecoder parentMessage = this;
    ...
    public OrderPartiallyFilledEventDecoder wrap(
    ...
    public OrderPartiallyFilledEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderPartiallyFilledEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[OrderPartiallyFilledEvent](sbeTemplateId=");
        ...
        builder.append('|');
        builder.append("fillQuantity=");
        builder.append(this.fillQuantity());
        builder.append('|');
    ...
    public OrderPartiallyFilledEventDecoder sbeSkip()
    {
        sbeRewind();
