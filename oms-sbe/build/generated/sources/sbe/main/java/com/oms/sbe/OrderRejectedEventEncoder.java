...
/**
 * Order failed validation or risk check
 */
@SuppressWarnings("all")
public final class OrderRejectedEventEncoder implements MessageEncoderFlyweight
{
    ...
    private final OrderRejectedEventEncoder parentMessage = this;
    ...
    public OrderRejectedEventEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrderRejectedEventEncoder wrapAndApplyHeader(
    ...
    public OrderRejectedEventEncoder sequenceNumber(final long value)
    {
    ...
    public OrderRejectedEventEncoder timestamp(final long value)
    {
    ...
    public OrderRejectedEventEncoder correlationId(final long value)
    {
    ...
    public OrderRejectedEventEncoder orderId(final long value)
    {
    ...
    public OrderRejectedEventEncoder accountId(final long value)
    {
    ...
    public OrderRejectedEventEncoder rejectReason(final RejectReason value)
    {
