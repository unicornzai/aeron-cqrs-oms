...
public final class AmendOrderCommandDecoder implements MessageDecoderFlyweight
{
    ...
    private final AmendOrderCommandDecoder parentMessage = this;
    ...
    public AmendOrderCommandDecoder wrap(
    ...
    public AmendOrderCommandDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public AmendOrderCommandDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[AmendOrderCommand](sbeTemplateId=");
        ...
        builder.append(this.newPrice());
        builder.append('|');
        builder.append("newQuantity=");
        builder.append(this.newQuantity());
    ...
    public AmendOrderCommandDecoder sbeSkip()
    {
        sbeRewind();
