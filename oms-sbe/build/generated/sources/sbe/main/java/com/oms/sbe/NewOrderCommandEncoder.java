...
public final class NewOrderCommandEncoder implements MessageEncoderFlyweight
{
    ...
    public NewOrderCommandEncoder sequenceNumber(final long value)
    {
    ...
    public NewOrderCommandEncoder timestamp(final long value)
    {
    ...
    public NewOrderCommandEncoder correlationId(final long value)
    {
    ...
    public NewOrderCommandEncoder orderId(final long value)
    {
    ...
    public NewOrderCommandEncoder accountId(final long value)
    {
    ...
    public NewOrderCommandEncoder instrument(final int index, final byte value)
    {
        if (index < 0 || index >= 12)
        {
    ...
    public NewOrderCommandEncoder putInstrument(final byte[] src, final int srcOffset)
    {
        final int length = 12;
    ...
    public NewOrderCommandEncoder instrument(final String src)
    {
        final int length = 12;
    ...
    public NewOrderCommandEncoder instrument(final CharSequence src)
    {
        final int length = 12;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public NewOrderCommandEncoder orderType(final OrderType value)
    {
    ...
    public NewOrderCommandEncoder price(final long value)
    {
    ...
    public NewOrderCommandEncoder quantity(final long value)
    {
