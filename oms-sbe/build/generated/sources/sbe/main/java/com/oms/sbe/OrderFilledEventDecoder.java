...
public final class OrderFilledEventDecoder implements MessageDecoderFlyweight
{
    ...
    private final OrderFilledEventDecoder parentMessage = this;
    ...
    public OrderFilledEventDecoder wrap(
    ...
    public OrderFilledEventDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderFilledEventDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[OrderFilledEvent](sbeTemplateId=");
    ...
    public OrderFilledEventDecoder sbeSkip()
    {
        sbeRewind();
